...
export default function BlogDetailsLikeEvent({ lang }: { lang: string }) {
  ...
  const border = isDark ? "border-white/[0.06]" : "border-[#f0b100]/10";
          ...
          <div className="lg:col-span-7 p-6 sm:p-10 md:p-12 flex flex-col justify-between">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Calendar size={14} className="text-[#f0b100]" />
                ...
                <div
                  className={`flex items-center gap-2 px-3 py-2 rounded-xl border ${border} ${innerSection} text-xs font-bold`}
                >
                  <Eye size={14} className="text-[#f0b100]" />
                  <span className="text-gray-400 font-mono">
              ...
              {!isLoggedIn && (
                <div className="text-[11px] font-bold text-[#f0b100] bg-[#f0b100]/5 border border-[#f0b100]/10 p-3 rounded-xl tracking-wide">
