...
export default function ScoutPackagesPage() {
  ...
  console.log("🔍 Scout packages:", scoutPackages);

  const handleSelect = (item: PackageType) => {
    let enumValue = "SCOUT_BASIC";
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-black">{t("Scout Packages")}</h1>
